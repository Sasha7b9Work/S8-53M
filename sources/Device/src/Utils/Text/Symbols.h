...
#define SYMBOL_MEM_INT_SHOW_SAVED   '\x6c'  /* Кнопка рисовать записанный сигнал в режиме ВНУТР ЗУ */
#define SYMBOL_MEM_INT_SHOW_BOTH    '\x8c'  /* Кнопка рисовать оба сигнала в режиме ВНУТР ЗУ */
...
#define SYMBOL_TPOS_1               '\x8a'  /* Символ TPos в окне памяти */
#define SYMBOL_TPOS_2               '\x8b'  /* 1-я часть символа TPos */
#define SYMBOL_TPOS_3               '\x8a'  /* 2-я часть символа TPos */
